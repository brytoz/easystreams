...
function Basketball() {
  ...
  const dataOneAPI = `${process.env.REACT_APP_ADMIN}/post-old-basketball`;
  const dataTwoAPI = `${process.env.REACT_APP_ADMIN}/post-new-update-basketball`;
  const dataThreeAPI = `${process.env.REACT_APP_ADMIN}/post-upcoming-basketball`;

  const {
    isLoading: loadingPost,
    error: errorPost,
    data: postData,
  } = useQuery(["post-new-update-basketball"], () =>
  ...
  } = useQuery(["upcoming-post-basketball"], () =>
  ...
  return (
    <Fragment>
        ...
        <div className="darkMode text-base w-full leading-loose flex justify-center items-center">
          <div className={`h-full flex-1 capitalize text-xs md:text-sm`}>
            ...
            <span
              ...
              className="py-3 w-full flex justify-center items-center space-x-5"
            >
      ...
      <div className="md:px-32 xl:px-64  mt-6 font-bold text-3xl flex items-center space-x-6 ">
        <BiBasketball className="yellow" size={24} />{" "}
        <h1>Basketball Streaming Update</h1>{" "}
        <BiBasketball className="yellow" size={24} />
      </div>
