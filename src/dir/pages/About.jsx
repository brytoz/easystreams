        ...
        <div className="  space-y-6 flex-wrap justify-center items-center ">
          ...
          <div className="text-base space-y-6 leading-loose  flex-wrap justify-center items-center">
            <p>
              ...
              channels were you can watch all your favorite football games. All
              our football TV channels are made easy and user friendly, meaning,
              streams placed on our site are been compatible with your mobile
              devices, tablets, computers and more. Through EASYSTREAMS, all
              your favorite leagues can be livestreamed starting from European
              Champions League, LaLiga, European Premier League, Bundesliga,
              Italian Ligue, Ligue 1 and all major to urnaments all around the
              globe. EASYSTREAMS website is entirely a free website with all
              credits given to official channels we get our streams from such as
              SkySports, Beinsports etc. Make sure to have a great time on our
              site while watching your favorite game.
            </p>
          </div>
        </div>
      </div>
